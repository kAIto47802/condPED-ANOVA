...
from cond_ped_anova._evaluator import (
    _get_distributions,
    _get_filtered_trials,
    _partition_by_regime,
)
from experiments._evaluator_registry import register_evaluator
...
@register_evaluator("local_marginal_variance")
        ...
        *,
        ...
        for param_name in params:
            ...
            for dist, region_trials_regime in regime_trials.items():
                ...
                param_importances[param_name] += (
                    regime_prob_target - regime_prob_region
                ) ** 2 / regime_prob_region
